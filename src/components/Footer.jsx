    ...
    <footer className="footer bg-white/[0.02] border-t border-white/5 py-12 mt-20">
      <div className="container mx-auto px-4 md:px-8 flex flex-col items-center">
        ...
        <div className="flex gap-10 mb-10">
          <motion.a whileHover={{ scale: 1.2, rotate: 10 }} href="https://github.com/Virus2006458" className="text-softWhite/40 hover:text-accent transition-colors"><Github size={24} /></motion.a>
